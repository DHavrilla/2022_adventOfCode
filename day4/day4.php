...
function partOne($array, $total)
{
	foreach ($array as $value) {
		...
		$elf1 = explode('-', trim($exValue[0]));
		$elf2 = explode('-', trim($exValue[1]));
		//$total += compareRanges($elf1, $elf2);
		$total += compareRanges2($elf1, $elf2);
	}
	return $total;
}

function compareRanges($elf1, $elf2): int
{
...
function compareRanges2($elf1, $elf2): int
{
